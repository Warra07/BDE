...
class ideeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('ActiviteBundle:Default:idee/layout/index.html.twig', array(
            'idees' => $idees,
        ));
    }
    ...
    {
        $idee = new Idee();
        $form = $this->createForm('Activite\ActiviteBundle\Form\ideeType', $idee)->add('Ajouter', SubmitType::class, array('label' => 'Envoyer'));;
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('bde_index', array('id' => $idee->getId()));
        }

        return $this->render('ActiviteBundle:Default:idee/layout/new.html.twig', array(
            'idee' => $idee,
    ...
    public function showAction(idee $idee)
    {
        ...
        return $this->render('ActiviteBundle:Default:idee/layout/show.html.twig', array(
            'idee' => $idee,
    ...
    public function editAction(Request $request, idee $idee)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('idee_edit', array('id' => $idee->getId()));
        }

        return $this->render('ActiviteBundle:Default:idee/layout/edit.html.twig', array(
            'idee' => $idee,
    ...
    private function createDeleteForm(idee $idee)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('idee_delete', array('id' => $idee->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
